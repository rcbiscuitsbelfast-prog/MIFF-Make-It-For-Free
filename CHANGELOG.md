...
### 🧹 Codebase Cleanup
- **DELETED**: Unity-specific directories (Assets/, Packages/, ProjectSettings/, UserSettings/)
- **DELETED**: Duplicate license files (LICENSE - kept LICENSE.md)
- **DELETED**: Duplicate roadmap files (Documents/ROADMAP.md - kept main ROADMAP.md)
- **DELETED**: Large unused asset files (Documents/johto_map.jpg ~3.9MB, Documents/kanto_map.png ~417KB)
- **DELETED**: Stale Python CLI tool (cli/npcs_pure/harness.py)
