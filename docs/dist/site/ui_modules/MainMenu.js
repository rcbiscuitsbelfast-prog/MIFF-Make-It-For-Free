export function init(opts = {}){
  return { state: { title: opts.title || 'Main Menu', buttons: opts.buttons || [{ label:'Start', id:'start' }, { label:'Credits', id:'credits' }] }, el: null, onAction: opts.onAction || (()=>{}), style: opts.style || null };
}
