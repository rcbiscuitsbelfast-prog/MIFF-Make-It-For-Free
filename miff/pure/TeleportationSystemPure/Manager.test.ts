...
import { TeleportationSystemPureManager } from './Manager';

describe('TeleportationSystemPureManager', () => {
  let manager: TeleportationSystemPureManager;

  beforeEach(async () => {
    manager = new TeleportationSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
