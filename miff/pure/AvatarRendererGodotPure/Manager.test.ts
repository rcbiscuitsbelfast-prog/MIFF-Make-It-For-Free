...
import { AvatarRendererGodotPureManager } from './Manager';

describe('AvatarRendererGodotPureManager', () => {
  let manager: AvatarRendererGodotPureManager;

  beforeEach(async () => {
    manager = new AvatarRendererGodotPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
