export class capabilities {
  ...
  name = 'DataVisualizationPure';
  description = 'DataVisualization module providing core functionality';
  version = '1.0.0';
  type: 'feature' | 'core' = 'feature';
  category = 'general';
  tags = ['miff', 'module', 'manager', 'datavisualization'];
  ...
  createdAt: Date = new Date('2025-10-12T10:07:58.167Z');
  updatedAt: Date = new Date('2025-10-12T10:07:58.167Z');
