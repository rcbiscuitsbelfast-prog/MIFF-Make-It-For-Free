...
import { DataVisualizationPureManager } from './Manager';
import { addGenericItemMethods } from '../shared/testing/ManagerTestHelpers';

describe('DataVisualizationPureManager', () => {
  // TODO: Implement missing Manager methods
  let manager: DataVisualizationPureManager;

  beforeEach(async () => {
    manager = new DataVisualizationPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
