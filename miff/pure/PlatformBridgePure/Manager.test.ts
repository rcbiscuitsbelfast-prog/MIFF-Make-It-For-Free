...
import { PlatformBridgePureManager } from './Manager';

describe('PlatformBridgePureManager', () => {
  let manager: PlatformBridgePureManager;

  beforeEach(async () => {
    manager = new PlatformBridgePureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
