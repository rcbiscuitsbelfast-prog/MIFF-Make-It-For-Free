...
import { CollisionSystemPureManager } from './Manager';

describe('CollisionSystemPureManager', () => {
  let manager: CollisionSystemPureManager;

  beforeEach(async () => {
    manager = new CollisionSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
