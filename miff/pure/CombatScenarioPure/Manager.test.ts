...
import { CombatScenarioPureManager } from './Manager';

describe('CombatScenarioPureManager', () => {
  let manager: CombatScenarioPureManager;

  beforeEach(async () => {
    manager = new CombatScenarioPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
