...
import { VisualItemEventPureManager } from './Manager';

describe('VisualItemEventPureManager', () => {
  let manager: VisualItemEventPureManager;

  beforeEach(async () => {
    manager = new VisualItemEventPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
