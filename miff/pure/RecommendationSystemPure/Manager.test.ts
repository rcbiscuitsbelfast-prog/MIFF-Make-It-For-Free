...
import { RecommendationSystemPureManager } from './Manager';

describe('RecommendationSystemPureManager', () => {
  let manager: RecommendationSystemPureManager;

  beforeEach(async () => {
    manager = new RecommendationSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
