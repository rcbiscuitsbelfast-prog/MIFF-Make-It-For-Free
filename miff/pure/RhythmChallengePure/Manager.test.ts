...
import { RhythmChallengePureManager } from './Manager';

describe('RhythmChallengePureManager', () => {
  let manager: RhythmChallengePureManager;

  beforeEach(async () => {
    manager = new RhythmChallengePureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
