...
import { BridgeInspectorPureManager } from './Manager';

describe('BridgeInspectorPureManager', () => {
  let manager: BridgeInspectorPureManager;

  beforeEach(async () => {
    manager = new BridgeInspectorPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
