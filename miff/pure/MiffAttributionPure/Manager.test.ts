...
import { MiffAttributionPureManager } from './Manager';

describe('MiffAttributionPureManager', () => {
  let manager: MiffAttributionPureManager;

  beforeEach(async () => {
    manager = new MiffAttributionPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
