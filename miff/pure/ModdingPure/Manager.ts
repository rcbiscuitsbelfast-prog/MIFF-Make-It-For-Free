...
export class ModdingPureManager {
  ...
  constructor(config: Partial<ModdingPureConfig> = {}) {
    ...
    console.info('ModdingPureManager initialized', {
      config: this.config,
  ...
  async initialize(): Promise<void> {
    if (this.isInitialized) {
      console.warn('ModdingPure', 'Manager already initialized');
      return;
    }

    try {
      console.info('ModdingPure', 'Initializing ModdingPureManager...');
      
      // Initialize core functionality
      await this.initializeCore();
      
      this.isInitialized = true;
      console.info('ModdingPure', 'ModdingPureManager initialized successfully');
  ...
  private async initializeCore(): Promise<void> {
    ...
    console.debug('ModdingPure', 'Initializing core functionality');
  ...
  private async createDefaultItems(): Promise<void> {
    console.debug('ModdingPure', 'Creating default items');
  ...
  // Get item by ID
  getItem(id: string): ModdingPureItem! {
  ...
  // Update item
  async updateItem(id: string, updates: Partial<ModdingPureItem>): Promise<ModdingPureItem!> {
    try {
  ...
  async destroy(): Promise<void> {
    try {
      console.info('ModdingPure', 'Destroying ModdingPureManager...');
      ...
      console.info('ModdingPure', 'ModdingPureManager destroyed successfully');
