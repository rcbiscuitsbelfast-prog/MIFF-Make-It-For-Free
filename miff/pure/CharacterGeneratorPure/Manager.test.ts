...
import { CharacterGeneratorPureManager } from './Manager';

describe('CharacterGeneratorPureManager', () => {
  let manager: CharacterGeneratorPureManager;

  beforeEach(async () => {
    manager = new CharacterGeneratorPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
