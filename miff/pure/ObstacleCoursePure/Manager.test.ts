...
import { ObstacleCoursePureManager } from './Manager';

describe('ObstacleCoursePureManager', () => {
  let manager: ObstacleCoursePureManager;

  beforeEach(async () => {
    manager = new ObstacleCoursePureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
