...
export class ObstacleCoursePureManager {
  ...
  constructor(config: Partial<ObstacleCoursePureConfig> = {}) {
    ...
    console.info('ObstacleCoursePureManager initialized', {
      config: this.config,
  ...
  async initialize(): Promise<void> {
    if (this.isInitialized) {
      console.warn('ObstacleCoursePure', 'Manager already initialized');
      return;
    }

    try {
      console.info('ObstacleCoursePure', 'Initializing ObstacleCoursePureManager...');
      
      // Initialize core functionality
      await this.initializeCore();
      
      this.isInitialized = true;
      console.info('ObstacleCoursePure', 'ObstacleCoursePureManager initialized successfully');
  ...
  private async initializeCore(): Promise<void> {
    ...
    console.debug('ObstacleCoursePure', 'Initializing core functionality');
  ...
  private async createDefaultItems(): Promise<void> {
    console.debug('ObstacleCoursePure', 'Creating default items');
  ...
  // Get item by ID
  getItem(id: string): ObstacleCoursePureItem! {
  ...
  // Update item
  async updateItem(id: string, updates: Partial<ObstacleCoursePureItem>): Promise<ObstacleCoursePureItem!> {
    try {
  ...
  async destroy(): Promise<void> {
    try {
      console.info('ObstacleCoursePure', 'Destroying ObstacleCoursePureManager...');
      ...
      console.info('ObstacleCoursePure', 'ObstacleCoursePureManager destroyed successfully');
