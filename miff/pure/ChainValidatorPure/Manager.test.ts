...
import { ChainValidatorPureManager } from './Manager';

describe('ChainValidatorPureManager', () => {
  let manager: ChainValidatorPureManager;

  beforeEach(async () => {
    manager = new ChainValidatorPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
