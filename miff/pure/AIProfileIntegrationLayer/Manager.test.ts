...
import { AIProfileIntegrationLayerManager } from './Manager';

describe('AIProfileIntegrationLayerManager', () => {
  let manager: AIProfileIntegrationLayerManager;

  beforeEach(async () => {
    manager = new AIProfileIntegrationLayerManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
