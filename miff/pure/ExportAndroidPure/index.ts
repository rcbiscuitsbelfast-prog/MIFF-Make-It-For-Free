...
export interface AndroidProjectSettings {
  ...
  androidCustomMainActivityOnPictureInPictureModeChanged: string;
  androidCustomMainActivityOnTopResumedActivityChanged: string;
  androidCustomMainActivityOnMultiWindowModeChanged: string;
  androidCustomMainActivityOnPictureInPictureUiStateChanged: string;
  androidCustomMainActivityOnCreateContextMenu: string;
  androidCustomMainActivityOnCreateNavigateUpTaskStack: string;
  androidCustomMainActivityOnNavigateUp: string;
  androidCustomMainActivityOnNavigateUpFromChild: string;
  androidCustomMainActivityOnCreateDescription: string;
  androidCustomMainActivityOnProvideStructure: string;
  androidCustomMainActivityOnDump: string;
...
export interface AndroidBuildOptions {
  ...
  enableCustomMainActivityOnPictureInPictureModeChangedUpdate: boolean;
  enableCustomMainActivityOnTopResumedActivityChangedUpdate: boolean;
  enableCustomMainActivityOnMultiWindowModeChangedUpdate: boolean;
  enableCustomMainActivityOnPictureInPictureUiStateChangedUpdate: boolean;
  enableCustomMainActivityOnCreateContextMenuUpdate: boolean;
  enableCustomMainActivityOnCreateNavigateUpTaskStackUpdate: boolean;
  enableCustomMainActivityOnNavigateUpUpdate: boolean;
  enableCustomMainActivityOnNavigateUpFromChildUpdate: boolean;
  enableCustomMainActivityOnCreateDescriptionUpdate: boolean;
  enableCustomMainActivityOnProvideStructureUpdate: boolean;
  enableCustomMainActivityOnDumpUpdate: boolean;
  enableCustomMainActivityOnProvideVirtualStructureUpdate: boolean;
  enableCustomMainActivityOnProvideContentCaptureStructureUpdate: boolean;
  enableCustomMainActivityOnReceiveContentUpdate: boolean;
  enableCustomMainActivityOnEnterPictureInPictureModeUpdate: boolean;
  enableCustomMainActivityOnExitPictureInPictureModeUpdate: boolean;
  enableCustomMainActivityOnMultiWindowModeChangedUpdate: boolean;
  enableCustomMainActivityOnPictureInPictureModeChangedUpdate: boolean;
  enableCustomMainActivityOnTopResumedActivityChangedUpdate: boolean;
  enableCustomMainActivityOnPictureInPictureUiStateChangedUpdate: boolean;
...
export interface AndroidBuildReport {
  ...
  buildSize: number;
  buildFiles: AndroidBuildFile[];
  buildDependencies: AndroidBuildDependency[];
  buildSteps: AndroidBuildStep[];
