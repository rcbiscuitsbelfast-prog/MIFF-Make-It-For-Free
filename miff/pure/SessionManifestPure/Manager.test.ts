...
import { SessionManifestPureManager } from './Manager';

describe('SessionManifestPureManager', () => {
  let manager: SessionManifestPureManager;

  beforeEach(async () => {
    manager = new SessionManifestPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
