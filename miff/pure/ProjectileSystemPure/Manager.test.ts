...
import { ProjectileSystemPureManager } from './Manager';

describe('ProjectileSystemPureManager', () => {
  let manager: ProjectileSystemPureManager;

  beforeEach(async () => {
    manager = new ProjectileSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
