...
import { ServiceDiscoveryPureManager } from './Manager';
import { addGenericItemMethods } from '../shared/testing/ManagerTestHelpers';

describe('ServiceDiscoveryPureManager', () => {
  // TODO: Implement missing Manager methods
  let manager: ServiceDiscoveryPureManager;

  beforeEach(async () => {
    manager = new ServiceDiscoveryPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
