...
import { VisualReplaySystemPureManager } from './Manager';

describe('VisualReplaySystemPureManager', () => {
  let manager: VisualReplaySystemPureManager;

  beforeEach(async () => {
    manager = new VisualReplaySystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
