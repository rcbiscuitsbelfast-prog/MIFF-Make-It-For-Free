...
import { WorkflowEnginePureManager } from './Manager';
import { addGenericItemMethods } from '../shared/testing/ManagerTestHelpers';

describe('WorkflowEnginePureManager', () => {
  // TODO: Implement missing Manager methods
  let manager: WorkflowEnginePureManager;

  beforeEach(async () => {
    manager = new WorkflowEnginePureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
