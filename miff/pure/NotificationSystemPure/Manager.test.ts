...
import { NotificationSystemPureManager } from './Manager';

describe('NotificationSystemPureManager', () => {
  let manager: NotificationSystemPureManager;

  beforeEach(async () => {
    manager = new NotificationSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
