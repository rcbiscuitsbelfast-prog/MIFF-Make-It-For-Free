...
import { TimelineSystemPureManager } from './Manager';

describe('TimelineSystemPureManager', () => {
  let manager: TimelineSystemPureManager;

  beforeEach(async () => {
    manager = new TimelineSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
