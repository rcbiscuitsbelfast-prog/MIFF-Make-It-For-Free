...
export class AudioEngine {
  ...
  async playSource(sourceId: string, options?: PlayOptions): Promise<void> {
    ...
    try {
      ...
      // Connect to master bus through gain node
  ...
  setSourceVolume(sourceId: string, volume: number): void {
    // Note: Volume control would need to be implemented through gain nodes
    // This is a simplified implementation
    console.log(`[AudioEngine] Setting volume for ${sourceId} to ${volume}`);
  }
