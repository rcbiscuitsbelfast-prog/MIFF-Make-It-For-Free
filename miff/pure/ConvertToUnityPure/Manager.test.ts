...
import { ConvertToUnityPureManager } from './Manager';

describe('ConvertToUnityPureManager', () => {
  let manager: ConvertToUnityPureManager;

  beforeEach(async () => {
    manager = new ConvertToUnityPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
