...
import { WebSocketBridgePureManager } from './Manager';

describe('WebSocketBridgePureManager', () => {
  let manager: WebSocketBridgePureManager;

  beforeEach(async () => {
    manager = new WebSocketBridgePureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
