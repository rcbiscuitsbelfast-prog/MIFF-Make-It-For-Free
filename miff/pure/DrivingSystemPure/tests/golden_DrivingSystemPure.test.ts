...
describe('DrivingSystemPure Golden Tests', () => {
  ...
  describe('Event System Integration', () => {
    test('should emit events for vehicle lifecycle', () => {
      ...
      eventBus?.on('driving:vehicle-created', (data: any) => {
        vehicleCreated = true;
      ...
      eventBus?.on('driving:engine-started', (data: any) => {
        engineStarted = true;
        expect(data?.vehicleId).toBeDefined();
        expect(data?.vehicleType).toBe('demo-car');
      });
    ...
    test('should emit events for damage and crashes', () => {
      ...
      eventBus?.on('driving:vehicle-damaged', (data: any) => {
        vehicleDamaged = true;
        expect(data?.vehicleId).toBeDefined();
      ...
      eventBus?.on('driving:vehicle-crashed', (data: any) => {
        vehicleCrashed = true;
        expect(data?.vehicleId).toBeDefined();
