...
import { WebSocketServerPureManager } from './Manager';

describe('WebSocketServerPureManager', () => {
  let manager: WebSocketServerPureManager;

  beforeEach(async () => {
    manager = new WebSocketServerPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
