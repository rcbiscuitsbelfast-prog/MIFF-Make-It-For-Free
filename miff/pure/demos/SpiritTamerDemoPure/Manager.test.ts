...
import { SpiritTamerDemoPureManager } from './Manager';

describe('SpiritTamerDemoPureManager', () => {
  let manager: SpiritTamerDemoPureManager;

  beforeEach(async () => {
    manager = new SpiritTamerDemoPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
