...
import { WitcherExplorerDemoPureManager } from './Manager';

describe('WitcherExplorerDemoPureManager', () => {
  let manager: WitcherExplorerDemoPureManager;

  beforeEach(async () => {
    manager = new WitcherExplorerDemoPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
