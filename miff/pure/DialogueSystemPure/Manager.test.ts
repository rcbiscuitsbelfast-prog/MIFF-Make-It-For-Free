...
import { DialogueSystemPureManager } from './Manager';

describe('DialogueSystemPureManager', () => {
  let manager: DialogueSystemPureManager;

  beforeEach(async () => {
    manager = new DialogueSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
