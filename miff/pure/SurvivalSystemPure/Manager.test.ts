...
import { SurvivalSystemPureManager } from './Manager';

describe('SurvivalSystemPureManager', () => {
  let manager: SurvivalSystemPureManager;

  beforeEach(async () => {
    manager = new SurvivalSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
