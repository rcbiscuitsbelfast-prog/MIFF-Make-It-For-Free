...
import { CutsceneSystemPureManager } from './Manager';

describe('CutsceneSystemPureManager', () => {
  let manager: CutsceneSystemPureManager;

  beforeEach(async () => {
    manager = new CutsceneSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
