...
import { InteractableRegistryPureManager } from './Manager';

describe('InteractableRegistryPureManager', () => {
  let manager: InteractableRegistryPureManager;

  beforeEach(async () => {
    manager = new InteractableRegistryPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
