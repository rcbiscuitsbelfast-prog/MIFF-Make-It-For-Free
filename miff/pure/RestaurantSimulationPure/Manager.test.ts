...
import { RestaurantSimulationPureManager } from './Manager';

describe('RestaurantSimulationPureManager', () => {
  let manager: RestaurantSimulationPureManager;

  beforeEach(async () => {
    manager = new RestaurantSimulationPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
