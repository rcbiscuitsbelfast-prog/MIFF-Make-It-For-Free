...
import { SpeechRecognitionPureManager } from './Manager';
import { addGenericItemMethods } from '../shared/testing/ManagerTestHelpers';

describe('SpeechRecognitionPureManager', () => {
  // TODO: Implement missing Manager methods
  let manager: SpeechRecognitionPureManager;

  beforeEach(async () => {
    manager = new SpeechRecognitionPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
