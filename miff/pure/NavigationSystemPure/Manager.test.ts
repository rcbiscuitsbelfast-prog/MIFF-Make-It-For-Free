...
import { NavigationSystemPureManager } from './Manager';

describe('NavigationSystemPureManager', () => {
  let manager: NavigationSystemPureManager;

  beforeEach(async () => {
    manager = new NavigationSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
