...
import { AvatarAssetRegistryPureManager } from './Manager';

describe('AvatarAssetRegistryPureManager', () => {
  let manager: AvatarAssetRegistryPureManager;

  beforeEach(async () => {
    manager = new AvatarAssetRegistryPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
