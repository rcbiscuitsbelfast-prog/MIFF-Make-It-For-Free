...
import { CryptocurrencyPureManager } from './Manager';

describe('CryptocurrencyPureManager', () => {
  let manager: CryptocurrencyPureManager;

  beforeEach(async () => {
    manager = new CryptocurrencyPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
