...
import { AvatarRendererWebPureManager } from './Manager';

describe('AvatarRendererWebPureManager', () => {
  let manager: AvatarRendererWebPureManager;

  beforeEach(async () => {
    manager = new AvatarRendererWebPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
