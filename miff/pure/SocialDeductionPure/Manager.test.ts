...
import { SocialDeductionPureManager } from './Manager';

describe('SocialDeductionPureManager', () => {
  let manager: SocialDeductionPureManager;

  beforeEach(async () => {
    manager = new SocialDeductionPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
