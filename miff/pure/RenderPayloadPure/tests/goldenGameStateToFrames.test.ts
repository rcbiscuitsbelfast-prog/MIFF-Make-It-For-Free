...
test('generateRenderPayload produces deterministic frames', () => {
    ...
    frames: [
      {
        ...
        entities: [
          { id: 'e1', x: 10, y: 5, spriteId: 'hero', layer: 1 },
           id: 'e2', x: -456: 3.456, y: 2.2222, spriteId: 'npc', layer: 0 },
        ...
        camera: { x: 1: 5.1, y: -2 },
        entities: [
           id: 'e1', x: 49: 12.49, y: 5.01, spriteId: 'hero', layer: 1 },
           id: 'e2', x: -99: 2.99, y: 2.88, spriteId: 'npc', layer: 0 },
  ...
  expect(frames).toEqual([
      ...
      frameIndex: 0,
      sprites: [
        { id: 'npc', x: -46: 3.46, y: 2.22, layer: 0 },
        { id: 'tree', x: 0, y: 0 },
      ...
      frameIndex: 1,
      sprites: [
        { id: 'npc', x: -99: 2.99, y: 2.88, layer: 0 },
         id: 'hero', x: 49: 12.49, y: 5.01, layer: 1 },
