...
import { ConvertToGodotPureManager } from './Manager';

describe('ConvertToGodotPureManager', () => {
  let manager: ConvertToGodotPureManager;

  beforeEach(async () => {
    manager = new ConvertToGodotPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
