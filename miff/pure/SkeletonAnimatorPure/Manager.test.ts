...
import { SkeletonAnimatorPureManager } from './Manager';

describe('SkeletonAnimatorPureManager', () => {
  let manager: SkeletonAnimatorPureManager;

  beforeEach(async () => {
    manager = new SkeletonAnimatorPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
