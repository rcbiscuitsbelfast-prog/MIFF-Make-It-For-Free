...
import { TutorialScenarioPureManager } from './Manager';

describe('TutorialScenarioPureManager', () => {
  let manager: TutorialScenarioPureManager;

  beforeEach(async () => {
    manager = new TutorialScenarioPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
