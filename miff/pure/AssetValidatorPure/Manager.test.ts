...
import { AssetValidatorPureManager } from './Manager';

describe('AssetValidatorPureManager', () => {
  let manager: AssetValidatorPureManager;

  beforeEach(async () => {
    manager = new AssetValidatorPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
