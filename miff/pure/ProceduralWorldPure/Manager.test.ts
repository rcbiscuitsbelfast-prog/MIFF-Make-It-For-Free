...
import { ProceduralWorldPureManager } from './Manager';

describe('ProceduralWorldPureManager', () => {
  let manager: ProceduralWorldPureManager;

  beforeEach(async () => {
    manager = new ProceduralWorldPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
