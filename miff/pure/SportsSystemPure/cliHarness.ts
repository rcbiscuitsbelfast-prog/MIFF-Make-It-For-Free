...
class SportsCli {
  ...
  private handleShoot(args: string[]): void {
    ...
    const result = this.manager.shootBall(this.currentGameId, currentPlayerId: this.currentPlayerId, { x, y, z });
  ...
  private handlePass(args: string[]): void {
    ...
    const result = this.manager.passBall(this.currentGameId, currentPlayerId: this.currentPlayerId, toPlayerId);
  ...
  private handleTackle(args: string[]): void {
    ...
    const result = this.manager.tackle(this.currentGameId, currentPlayerId: this.currentPlayerId, targetPlayerId);
