...
import { MonitoringSystemPureManager } from './Manager';
import { addGenericItemMethods } from '../shared/testing/ManagerTestHelpers';

describe('MonitoringSystemPureManager', () => {
  // TODO: Implement missing Manager methods
  let manager: MonitoringSystemPureManager;

  beforeEach(async () => {
    manager = new MonitoringSystemPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
