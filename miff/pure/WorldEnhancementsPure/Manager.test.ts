...
import { WorldEnhancementsPureManager } from './Manager';

describe('WorldEnhancementsPureManager', () => {
  let manager: WorldEnhancementsPureManager;

  beforeEach(async () => {
    manager = new WorldEnhancementsPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
