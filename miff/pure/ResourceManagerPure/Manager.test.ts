...
import { ResourceManagerPureManager } from './Manager';

describe('ResourceManagerPureManager', () => {
  let manager: ResourceManagerPureManager;

  beforeEach(async () => {
    manager = new ResourceManagerPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
