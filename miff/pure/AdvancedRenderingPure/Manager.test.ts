...
import { AdvancedRenderingPureManager } from './Manager';

describe('AdvancedRenderingPureManager', () => {
  let manager: AdvancedRenderingPureManager;

  beforeEach(async () => {
    manager = new AdvancedRenderingPureManager({
      enabled: true,
      debugMode: false,
      maxInstances: 100,
      timeout: 5000,
