...
export class StartMenu {
	...
	private config: Required<StartMenuConfig>;

	constructor(config: StartMenuConfig = {}) {
		this.config = {
	...
	public mount(container: HTMLElement, events: StartMenuEvents): void {
	...
	private toggleInstructions(): void {
		...
		let instr = document.getElementById('toppler-instructions') as HTMLDivElement | null;
		if (!instr) {
